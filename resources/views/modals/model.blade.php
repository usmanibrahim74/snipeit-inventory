        ...
        <div class="modal-body">
            <form action="{{ route('api.models.store') }}" onsubmit="return false">
                ...
                <div class="dynamic-form-row">
                    ...
                    <div class="col-md-8 col-xs-12 required">{{ Form::select('fieldset_id', \App\Helpers\Helper::customFieldsetList(),Request::old('fieldset_id'), array('class'=>'select2', 'id'=>'modal-fieldset_id', 'style'=>'width:300px')) }}</div>
                </div>
        </div>
